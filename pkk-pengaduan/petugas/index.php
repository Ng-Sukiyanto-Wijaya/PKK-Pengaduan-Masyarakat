          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#name"><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a> <a href='' target='_blank'></a>
              ...
              <li><a class="waves-effect" href="../login.php"><i class="material-icons">logout</i>Logout</a></li>
          </ul>
